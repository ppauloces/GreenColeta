<div class="content">
    ...
    <ul class="sidenav" id="mobile-demo">
        <li><a href="<?= URL . 'dados.php' ?>" style="color: #538D22"><i class="material-icons left" style="margin-right: 5px;color: #538D22">info_outline</i>Dados</a></li>
        <li><a href="historico.php" style="color: #538D22"><i class="material-icons left" style="margin-right: 5px;color: #538D22">history</i>Histórico</a></li>
        <li class="divider"></li>
